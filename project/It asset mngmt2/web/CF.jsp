<%-- 
    Document   : CF
    Created on : Apr 20, 2016, 12:42:47 PM
...
<html>
            ...
            <%re=st.executeQuery("Select * From COMPANY");%>
            <h3 align="center">FeedBacks Lists Table</h3>
            <table align="center" border="3" bgcolor="rgba('211','211','211','0.63')" class="def"><th>Employee ID</th><th>Employee Name</th><th>Comments</th><th>Delete</th>
            <%while(re.next())
            {%>
