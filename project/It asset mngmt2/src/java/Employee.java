...
public class Employee extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String Euname=request.getParameter("Employee-username");
        String Epass=request.getParameter("Employee-password");
        String Erpass=request.getParameter("Employee-repassword");
        String Eposition=request.getParameter("Employee-position");
...
ex.printStackTrace();
        ...
        try {
           ...
           int i= st.executeUpdate("Insert into Employee values('"+Ename+"','"+Eid+"','"+Eemail+"','"+Econtact+"','"+Esupid+"','"+Esup+"','"+Eorganisation+"','"+Ebuilding+"','"+Edept+"','"+Eremarks+"','"+Euname+"','"+Epass+"','"+Eposition+"')");
            ...
            out.println("<a href='employeelogin.html'><input type='button' value='Back'/></a>");
